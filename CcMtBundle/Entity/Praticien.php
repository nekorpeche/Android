 ...
 * @ORM\Entity(repositoryClass="CcMtBundle\Repository\PraticienRepository")
 */
class Praticien implements \JsonSerializable
{
     ...
     * Set praTypecode
     *
     * @param \CcMtBundle\Entity\TypePraticien $praTypecode
     *
     * @return Praticien
     */
    public function setPraTypecode(\CcMtBundle\Entity\TypePraticien $praTypecode = null)
    {
     ...
     * Get praTypecode
     *
     * @return \CcMtBundle\Entity\TypePraticien
     */
     ...
     * Set praVisiteur
     *
     * @param \CcMtBundle\Entity\Visiteur $praVisiteur
     *
     * @return Praticien
     */
    public function setPraVisiteur(\CcMtBundle\Entity\Visiteur $praVisiteur = null)
    {
    ...
    public function jsonSerialize() {
        ...
        return array(
            "praNum"=>$this->getPraNum(),
            "praNom"=>$this->getPraNom(),
            "praPrenom"=>$this->getPraPrenom(),
            ...
            "praVisiteur"=>$this->getPraVisiteur()->getVisMatricule()
            );
    }
